...
def get_target_positions(action, ):
    ...
    transformed_pos[6] = abstract_actions[0]
    transformed_pos[7] = abstract_actions[1]
    transformed_pos[8] = abstract_actions[2]
    ...
    transformed_pos[9] = abstract_actions[3]
    transformed_pos[10] = abstract_actions[4]
    transformed_pos[11] = abstract_actions[5]
