import my_hexapod_synchronized_legs_env_v5 as rvd
import numpy as np
...
plt.title("total_reward vs Episodes synchronized_Q_learning v5")
plt.xlabel("Num Episodes")
plt.ylabel("Total Reward")
plt.show()
plt.savefig("total_reward vs Episodes synchronized_Q_learning v5.png")

plt.plot(num_steps_walked_per_episode)
plt.title("steps vs Episodes synchronized Q learning v5.")
plt.xlabel("Num Episodes")
plt.ylabel("Steps")
plt.show()
plt.savefig("steps vs Episodes synchronized Q learning v5.png")


np.save("Q_table_synchronized v5.npy", Q_table)
