...
plt.title("total_reward vs Episodes synchronized_Q_learning")
plt.xlabel("Num Episodes")
plt.ylabel("Total Reward")
plt.show()
plt.savefig("total_reward vs Episodes synchronized_Q_learning.png")

plt.plot(num_steps_walked_per_episode,np.arange(len(num_steps_walked_per_episode))*50)
plt.title("steps vs Episodes synchronized Q learning.")
plt.xlabel("Num Episodes")
plt.ylabel("Steps")
plt.show()
plt.savefig("steps vs Episodes synchronized Q learning.png")


np.save("Q_table_synchronized.npy", Q_table)
