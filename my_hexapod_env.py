...
"""
File to store variable definations and functionsn for discritizing 
"""
num_motors = 18
num_legs = 6
...
Total_actions = Num_actions_per_motor**num_motors
Total_states = discrete_observations**num_state_observations
Q_table_size = Total_states*Total_actions
...
def get_target_positions(action):
    ...
    positions = decimal_action_to_executable(number=action,output_base=Num_actions_per_motor)
    transformed_pos = np.array(positions) * math.pi/2
