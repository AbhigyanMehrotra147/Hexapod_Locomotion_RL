import my_hexapod_synchornized_legs_env_v4 as rvd
import numpy as np
...
for episode in range(episodes):
    ...
    while not done:
        ...
        reward = rvd.get_reward(20,2,1,p,Hexapod)
...
plt.title("total_reward vs Episodes synchronized_Q_learning v4")
plt.xlabel("Num Episodes")
plt.ylabel("Total Reward")
plt.show()
plt.savefig("total_reward vs Episodes synchronized_Q_learning v4.png")

plt.plot(num_steps_walked_per_episode)
plt.title("steps vs Episodes synchronized Q learning v4.")
plt.xlabel("Num Episodes")
plt.ylabel("Steps")
plt.show()
plt.savefig("steps vs Episodes synchronized Q learning v4.png")


np.save("Q_table_synchronized v4.npy", Q_table)
