import my_hexapod_synchronized_legs_env_v3 as rvd
import numpy as np
...
for episode in range(episodes):
    ...
    while not done:
        ...
        reward = rvd.get_reward(20,2,0.2,p,Hexapod)
...
plt.title("total_reward vs Episodes synchronized_Q_learning v6")
plt.xlabel("Num Episodes")
plt.ylabel("Total Reward")
plt.show()
plt.savefig("total_reward vs Episodes synchronized_Q_learning v6.png")

plt.plot(num_steps_walked_per_episode)
plt.title("steps vs Episodes synchronized Q learning v6.")
plt.xlabel("Num Episodes")
plt.ylabel("Steps")
plt.show()
plt.savefig("steps vs Episodes synchronized Q learning v6.png")


np.save("Q_table_synchronized v6.npy", Q_table)
