...
plt.title("total_reward vs Episodes synchronized_Q_learning v9")
plt.xlabel("Num Episodes")
plt.ylabel("Total Reward")
plt.show()
plt.savefig("total_reward vs Episodes synchronized_Q_learning v9.png")

plt.plot(num_steps_walked_per_episode)
plt.title("steps vs Episodes synchronized Q learning v9.")
plt.xlabel("Num Episodes")
plt.ylabel("Steps")
plt.show()
plt.savefig("steps vs Episodes synchronized Q learning v9.png")


np.save("Q_table_synchronized v9.npy", Q_table)
